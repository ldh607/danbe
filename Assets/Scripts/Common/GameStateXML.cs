...
public class GameStateXML : MonoBehaviour
{
...
#else
        _FileLocation = Application.streamingAssetsPath;// Application.dataPath;       
        FileInfo t = new FileInfo(_FileLocation + "\\Setting\\" + _FileName);
    ...
    public static string LoadXML(string _FileName)
    {
        ...
        {
            r = File.OpenText(_FileLocation + "\\Setting\\" + _FileName);
            _info = r.ReadToEnd();
            r.Close();
        }
