...
public class Emotion : MonoBehaviour {
	...
	public void Start() {
		if (Target == null) {
			if (transform.FindChild("Emotions"))
				Target = transform.FindChild("Emotions").gameObject;
			else
	...
	public void RemoveEmotion(int i) {
		if (Target.transform.FindChild(Emotions[i].name))
			Destroy(Target.transform.FindChild(Emotions[i].name).gameObject);
	}
